...
public class ApiEmployeeController {
	...
	public ResponseEntity<EmployeeResponseDto> registerEmployee(
			@Parameter(name = "사원등록", in = ParameterIn.PATH, description = "사원 등록 정보", required = true) @RequestBody EmployeeRequestDto requestDto) {
	...
	public ResponseEntity<EmployeeResponseDto> changeEmployeeProfile(
			@Parameter(name = "ChangePasswordRequestDto", description = "회원정보 재설정", in = ParameterIn.PATH)
			@Valid @RequestBody final ChangeMyProfile requestDto) {
